...
ALTER TABLE product_transfer ADD CONSTRAINT product_transfer_62cc0abde17fc FOREIGN KEY (deposit_origin) references deposit(id); 
ALTER TABLE product_transfer ADD CONSTRAINT fk_product_transfer_product FOREIGN KEY (product) references product(id); 
ALTER TABLE product_transfer ADD CONSTRAINT product_transfer_62cc0abde1821 FOREIGN KEY (deposit_destiny) references deposit(id); 
ALTER TABLE product_transfer ADD CONSTRAINT product_transfer_62cc0abde1834 FOREIGN KEY (product_storage_origin) references product_storage(id); 
ALTER TABLE product_transfer ADD CONSTRAINT product_transfer_62cc0abde1845 FOREIGN KEY (product_storage_destiny) references product_storage(id); 
ALTER TABLE product_validate_date ADD CONSTRAINT product_validate_date_62cc0abde1a2c FOREIGN KEY (product) references product(id); 
