...
class ProviderForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Cnpj:", '#ff0000', '14px', null, '100%'),$cnpj],[new TLabel("Fantasy name:", null, '14px', null, '100%'),$fantasy_name]);
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Estoque","Cadastro de Fornecedor"]));
        }
