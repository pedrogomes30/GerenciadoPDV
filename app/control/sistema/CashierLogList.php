...
class CashierLogList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de registro do caixa");
        $this->limit = 20;
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Dt login:", null, '14px', null, '100%'),$dt_login]);
        $row1->layout = ['col-sm-6','col-sm-6'];

        $row2 = $this->form->addFields([new TLabel("Dt logout:", null, '14px', null, '100%'),$dt_logout],[new TLabel("User:", null, '14px', null, '100%'),$user]);
        $row2->layout = ['col-sm-6','col-sm-6'];

        $row3 = $this->form->addFields([new TLabel("Cashier id:", null, '14px', null, '100%'),$cashier_id],[]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['CashierLogForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_dt_login = new TDataGridColumn('dt_login', "Dt login", 'left');
        $column_dt_logout = new TDataGridColumn('dt_logout', "Dt logout", 'left');
        $column_user = new TDataGridColumn('user', "User", 'left');
        $column_cashier_id = new TDataGridColumn('cashier_id', "Cashier id", 'left');
        ...
        $this->datagrid->addColumn($column_dt_login);
        $this->datagrid->addColumn($column_dt_logout);
        $this->datagrid->addColumn($column_user);
        $this->datagrid->addColumn($column_cashier_id);

        $action_onEdit = new TDataGridAction(array('CashierLogForm', 'onEdit'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Sistema","Registro do Caixa"]));
        }
